...
HiggsPluginAPI::IHiggsInterface001 * HiggsPluginAPI::GetHiggsInterface001(const SKSE::PluginHandle & pluginHandle, SKSE::detail::SKSEMessagingInterface * messagingInterface)
{
	...
	{
		SKSE::log::info("Higgs dispatch message returned true...");
	}
	else
	{
		SKSE::log::info("Higgs dispatch message returned false...");
	}
