...
namespace PapyrusVR
{
	...
	public:
		...
		//Conversions
		static void CopyMatrix34ToNiTrasform(Matrix34* matrix, RE::NiTransform* transform);
		static void CopyNiTrasformToMatrix34(RE::NiTransform* transform, Matrix34* matrix);
